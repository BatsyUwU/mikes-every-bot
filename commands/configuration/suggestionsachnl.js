...
module.exports = {
    ...
    run: async(bot, message, args)=>{
        ...
        if(typeof channel === 'undefined') return message.channel.send(`Please provide a valid channel.`)
        await channel.createWebhook(bot.user.username, bot.user.displayAvatarURL())
